...
const styles = StyleSheet.create({
  ...
  listBox: {    
    ...
    width: '100%',
    alignItems: 'center',
    backgroundColor: 'red', // A light background for the list container, similar to the calculator's background
    borderRadius: 15, // Rounded corners for the container
    padding: 20, // Inner padding to give content some space
    marginHorizontal: 0, // Horizontal margin to prevent it from touching the screen edges
